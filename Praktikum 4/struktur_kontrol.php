...
for($i = 1; $i <= $jumlahLahan; $i++) {
    ...
    echo "Lahan ke-$i: total buah sampai sekarang = $jumlahBuah <br>";
}
...
$totalSkor = 0;
echo "Skor ujian: " . implode(", ", $skorUjian) . "<br><br>";

foreach ($skorUjian as $skor) {
    $totalSkor += $skor;
    echo "Menambahkan skor $skor, total sementara = $totalSkor <br>";
}
